...
const Odds = props => {
  ...
  return (
    <div className="odds">
      {props.levelDone ? (
        <p>
          Nice you did it! Your odds for passing this level were 1:{
            props.levelTotalOdds
          }
        </p>
      ) : (
        <p>
          Your odds of making the wrong choice:{" "}
          <a className="percent">{odds.toFixed(2)}%</a>
          {odds === 100 && (
            <img
              src={require("../img/skull.png")}
              alt="img of skull"
              className="skullimage"
            />
          )}
        </p>
      )}
